    ...
    $.kc.fab = function (el, links, options) {
        ...
        base.init = function () {
            ...
            if (base.links.length > 0) {
                ...
                main_btn_dom = "<button " + ((main_btn.id) ? "id='" + main_btn.id + " '" : "") + " data-link-href='" + ((main_btn.url) ? main_btn.url : "") + "' data-link-target='" + ((main_btn.target) ? main_btn.target : "") + "' class='kc_fab_main_btn' style='" + bg_color_style + "'><span style='" + color_style + "'>" + main_btn.icon + "</span></button>";
                ...
                for (var i = 0; i < base.links.length; i++) {
                    ...
                    sub_fab_btns_dom += "<div><button " + (base.links[i].id ? "id='" + base.links[i].id + "' " : "") + " data-link-title='" + base.links[i].title + "' data-link-href='" + (base.links[i].url ? base.links[i].url : "") + "' data-link-target='" + ((base.links[i].target) ? base.links[i].target : "") + "' class='sub_fab_btn" + ((base.links[i].class) ? " " + base.links[i].class : "") + "' style='" + bg_color_style + "'><span style='" + color_style + "'>" + base.links[i].icon + "</span></button></div>";
            ...
            main_fab_btn.on('click', function (e) {
